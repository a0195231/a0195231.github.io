...
NexT.utils = {
  ...
  registerCopyCode: function() {
    ...
    figure.forEach(element => {
      ...
      element.insertAdjacentHTML('beforeend','<div class="copy-btn" style="red"><i class="fa fa-copy fa-fw ">CLICK HERE</i></div>');
      ...
      button.addEventListener('click', () => {
        ...
        button.querySelector('i').className = result ? 'fa fa-check-circle fa-fw animated shake' : 'fa fa-times-circle fa-fw';
        button.text.visibility = false;
        ta.blur(); // For iOS
        button.blur();
